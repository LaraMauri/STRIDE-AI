...
|Learning algorithms|Integrity,<br />Confidentiality,<br />Availability|Tampering,<br />Disclosure,<br />DoS|Several deliberate attack techniques, including adversarial examples, aim to subvert ML learning algorithms, but algorithmic leakage due to poor choice of learning algorithms is also known to cause extraction of sensitive information.|
